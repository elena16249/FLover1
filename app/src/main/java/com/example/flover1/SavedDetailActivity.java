...
public class SavedDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            ...
            Log.d("fuuuck ", "getName " + flower.getName() + " \n " + "getDescription " + "\n" + "getCondition1" +
                    flower.getCondition1() + "\n" + "getCondition2" + flower.getCondition2() + "\n" + "getCondition3" + flower.getCondition3()
                    + "\n" + "getCondition4" + flower.getCondition4());
